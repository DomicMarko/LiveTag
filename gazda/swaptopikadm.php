<?php
			...
			if(mysql_num_rows($result) == 0 || mysql_num_rows($result2) == 0) {
				 header("Location: adminmoderator.php?Messagexyz=" . urlencode('Ne postoji takav topik u bazi.'));
				 exit();
			}
			...
			header("Location: adminmoderator.php?Messagexy=" . urlencode('Uspesno ste swapovali topike.'));
			}
?>
